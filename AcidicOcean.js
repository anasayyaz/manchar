...
function GetMusic2Volume() {
    return Params.Music2Volume;
}

function GetVoiceVolume() {
    return Params.VoiceVolume;
}

function GetSoundVolume() {
    return Params.SoundVolume;
}
...
function Init() {
    ...
    Hud.PauseButton.OnClicked = function() {
        OnPauseToggle(Hud.PauseButton);
    };
...
function UpdateSceneVisibility(Time) {
    ...
    const Actors = GetActorScene(function() {
        return true;
    });
